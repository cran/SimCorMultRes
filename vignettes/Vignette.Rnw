...
correlated ordinal multinomial responses under the marginal cumulative link model specification in (\ref{MCLM}) are generated. This approach is based on the threshold approach mentioned in McCullagh (1980).\\
